...
메인 헤드라인을 "Nvidia’s (NVDA) Explosive Run May See Limits Going Forward, Warns JPMorgan"로 고정하고 파생 뉴스 3개를 연결했습니다. 이 출력은 시황 해석 에이전트의 입력으로 넘어갑니다.
References: live-semiconductors-nvidia-s-nvda-explosive-run-may-see-limits-going-forward-warns-jpmorgan, live-semiconductors-dow-jones-futures-nasdaq-s-p-500-set-more-record-highs-micron-nvidia-sandisk-alp, live-semiconductors-nebius-ai-cloud-3-5-launch-tests-rich-valuation-and-growth-hopes, live-semiconductors-nvidia-s-next-ai-superchip-needs-a-new-kind-of-memory-and-one-company-controls-i

### 02 Macro Analyst -> Ticker Analyst
지금 시장은 반도체 리더십과 방어형 에너지로 자금이 압축되는 국면입니다. 이 해석은 티커 딥분석과 행동 제안 에이전트의 공통 컨텍스트가 됩니다.
References: live-semiconductors-nvidia-s-nvda-explosive-run-may-see-limits-going-forward-warns-jpmorgan, live-semiconductors-dow-jones-futures-nasdaq-s-p-500-set-more-record-highs-micron-nvidia-sandisk-alp
